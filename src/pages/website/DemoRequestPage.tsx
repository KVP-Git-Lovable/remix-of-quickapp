...
export default function DemoRequestPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-12 px-3 sm:px-4 bg-gradient-to-b from-primary/10 to-background">
        <div className="container mx-auto max-w-4xl text-center">
          <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-3 sm:px-4 py-2 mb-6">
